...
```
docker run -d --name redis-stack -p 6379:6379 -p 8001:8001 -v ${pwd}/config/redis.conf:/etc/redis -v redis-volume:/data/  -e REDIS_ARGS="--requirepass redis-stack-password" -e REDIS_ARGS="--save 60 1000 --appendonly yes" -e REDISTIMESERIES_ARGS="RETENTION_POLICY=20" redis/redis-stack:latest
