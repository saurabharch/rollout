...
var SubscriptionLog = require('../model/subscriptionLog');
      ...
      subscriptions.forEach(function(s) {
        ...
        // winston.debug("s",s);
          ...
          var signOptions = {
            ...
            audience:  'https://rollout.com/subscriptions/'+s._id,        
          };

          if (s.global==true){
            signOptions.audience = 'https://rollout.com';
