...
class FaqBotHandler {
    ...
    static is_command(text) {
        ...
        // console.log("RolloutChatbotUtil.AGENT_COMMAND:", RolloutChatbotUtil.AGENT_COMMAND.replace(/\\\\/g, '\\'));
        //const agent_pattern = new RegExp('^(' + RolloutChatbotUtil.AGENT_COMMAND.replace(/\\/g, '\\\\') + ')$', 'm');
