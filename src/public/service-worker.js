...
try {
  var _pgSd = {
    site: {
      sI: "https://assetscdn.localhost:5500/site_images/f918a1521699808.png",
    ...
    widget: {
      ...
      bWBoxImg: {
        url: "https://assetscdn.localhost:5500/site_assets/img/",
        chrome: "chrome.jpg",
        firefox: "firefox.jpg",
        chromeM: "chromeM.jpg",
    ...
    welcomeNoti: {
      ...
      notification_url: "https://www.localhost:5500/schedule_demo",
  ...
  var _pgD = {
    ...
    merchantSettings: {
      sm: function(parms) {
        ...
        if (_pgSd.site.plateform == "shopify") {
          smPath.worker = "/service-worker.js";
        }
        switch (parms) {
          case "worker":
    ...
    getDataUrl: function(n) {
      ...
      const publicUrl = new URL("http://localhost:5500");
      var url = publicUrl;
      n = n.replace(/[\[\]]/g, "\\$&");
