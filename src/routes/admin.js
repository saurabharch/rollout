...
// insert a user
router.post('/setup_action', async (req, res) => {
  const db = req.app.db;
...
// dashboard
router.get('/dashboard', csrfProtection, restrict, async (req, res) => {
...
// create API key
router.post('/createApiKey', restrict, checkAccess, async (req, res) => {
  const db = req.app.db;
...
// settings update
router.post('/settings/update', restrict, checkAccess, (req, res) => {
...
router.get(
  ...
  async (req, res) => {
    const db = req.app.db;
    res.render('index/settings-menu', {
      title: 'Cart menu',
      session: req.session,
      admin: true,
      message: clearSessionValue(req.session, 'message'),
...
router.get(
  ...
  async (req, res) => {
    ...
    res.render('index/settings-pages', {
      title: 'Static pages',
      pages: pages,
      session: req.session,
      admin: true,
...
// insert/update page
router.post('/settings/page', restrict, checkAccess, async (req, res) => {
  const db = req.app.db;
...
// new menu item
router.post('/settings/menu/new', restrict, checkAccess, (req, res) => {
...
router.post('/validatePermalink', async (req, res) => {
...
router.get(
  '/settings/discount/new',
  csrfProtection,
  restrict,
  checkAccess,
  async (req, res) => {
    res.render('index/settings-discount-new', {
...
router.post('/testEmail', restrict, (req, res) => {
...
router.post('/searchall', restrict, async (req, res, next) => {
  const db = req.app.db;
